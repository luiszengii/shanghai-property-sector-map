...
| 地图新增但未采集 | 青浦、松江、金山 30 块、徐汇 12 块及长宁 4 块已登记为 `map_sectors_without_xhs_sample`；无样本、无分析结论、无代表来源 |
...
同日继续新增长宁新华路、天山、仙霞、北新泾 4 个同名街道低置信候选；本地快照没有对应采集。它们只追加到 `map_sectors_without_xhs_sample`。中山公园、虹桥、古北、西郊仍在自定义边界研究中，不登记成已有地图板块，也不生成观点结论。
