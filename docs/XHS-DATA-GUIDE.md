...
| 地图新增但未采集 | 青浦、松江、金山 30 块、徐汇 12 块、长宁 7 块、静安—普陀 12 块、虹口—杨浦 8 块、宝山 7 块、嘉定 7 块、闵行 12 块、浦东 8 块，以及奉贤 9 块，共 112 块已登记为 `map_sectors_without_xhs_sample`；无样本、无分析结论、无代表来源 |
