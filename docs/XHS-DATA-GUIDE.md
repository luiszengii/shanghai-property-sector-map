...
| 地图新增但未采集 | 青浦、松江、金山 30 块、徐汇 12 块及长宁 6 块已登记为 `map_sectors_without_xhs_sample`；无样本、无分析结论、无代表来源 |
...
同日继续新增长宁新华路、天山、仙霞、北新泾 4 个同名街道低置信候选，并按官方古北新区四至新增古北中置信候选、按虹桥街道扣除古北新增住宅虹桥低置信候选；本地快照没有这 6 个板块的对应采集。它们只追加到 `map_sectors_without_xhs_sample`，不得复用已有“虹桥商务区”样本，也不生成空分析。中山公园与西郊仍在自定义边界研究中，不登记成已有地图板块。
