...
| 地图新增但未采集 | 青浦、松江、金山 30 块、徐汇 12 块、长宁 7 块及静安—普陀新增批次中的 10 块已登记为 `map_sectors_without_xhs_sample`；无样本、无分析结论、无代表来源 |
...
同日新增静安南京西路、静安寺、曹家渡、江宁路，以及普陀长寿路、曹杨、真如、长风、长征、桃浦、万里共 11 个同名或稳定简称行政骨架候选。其中真如与批次 D 已采集的同一市场身份一致，继续使用既有真如样本和分析；其余 10 个名称没有对应采集，只进入 `map_sectors_without_xhs_sample`，不得互相借用样本或生成空分析。桃浦完整镇域明显过宽，仅是待显著收窄的起画代理。石门二路、宝山路、芷江西路、共和新路、彭浦新村、不夜城、苏河湾、阳城—永和、武宁、真光、光新、甘泉宜川仍未通过本批直接映射门槛，不登记成已有地图板块，也不为它们生成 XHS 空分析。
