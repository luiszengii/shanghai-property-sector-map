...
PENDING_MAP_SECTORS_WITHOUT_XHS_SAMPLE = {
    ...
    "长宁区": ("新华路", "天山", "仙霞", "北新泾", "古北", "虹桥", "中山公园"),
    "静安区": ("南京西路", "静安寺", "曹家渡", "江宁路"),
    "普陀区": ("长寿路", "曹杨", "长风", "长征", "桃浦", "万里", "甘泉宜川", "中远两湾城"),
    "虹口区": ("四川北路", "曲阳", "凉城", "江湾镇"),
    "杨浦区": ("控江路", "五角场", "鞍山", "中原"),
    "宝山区": ("张庙", "淞南", "高境", "杨行", "罗店", "月浦", "罗泾"),
    "嘉定区": ("江桥", "马陆", "徐行", "外冈", "安亭", "华亭", "菊园新区"),
    "闵行区": ("华漕", "梅陇", "颛桥", "马桥", "吴泾", "浦江镇", "静安新城", "闵行金汇", "龙柏", "航华", "金虹桥", "老闵行"),
    "浦东新区": ("高行", "曹路", "合庆", "大团", "泥城", "书院", "万祥", "老港", "洋泾", "塘桥", "金杨", "南码头", "潍坊", "花木"),
