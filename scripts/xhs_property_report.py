...
PENDING_MAP_SECTORS_WITHOUT_XHS_SAMPLE = {
    "徐汇区": ("徐家汇", "湖南路", "天平路", "枫林路", "斜土路", "龙华", "田林", "漕河泾", "康健", "凌云路", "长桥", "华泾"),
    "长宁区": ("新华路", "天山", "仙霞", "北新泾", "古北", "虹桥", "中山公园", "西郊"),
    "静安区": ("南京西路", "静安寺", "曹家渡", "江宁路", "不夜城", "阳城", "永和", "彭浦", "镇宁路", "西藏北路", "闸北公园"),
    "普陀区": ("长寿路", "曹杨", "长风", "长征", "桃浦", "万里", "甘泉宜川", "中远两湾城", "武宁", "真光", "光新"),
    "虹口区": ("四川北路", "曲阳", "凉城", "江湾镇", "瑞虹新城", "鲁迅公园"),
    "杨浦区": ("控江路", "五角场", "鞍山", "中原", "东外滩", "定海路", "黄兴公园"),
    "宝山区": ("张庙", "淞南", "高境", "杨行", "罗店", "月浦", "罗泾", "大华", "上大", "共康", "淞宝"),
    "嘉定区": ("江桥", "马陆", "徐行", "外冈", "安亭", "华亭", "菊园新区", "丰庄", "嘉定新城", "嘉定老城"),
    "闵行区": ("华漕", "梅陇", "颛桥", "马桥", "吴泾", "浦江镇", "静安新城", "龙柏", "航华", "金虹桥", "老闵行"),
    "浦东新区": ("高行", "曹路", "合庆", "大团", "泥城", "书院", "万祥", "老港", "洋泾", "塘桥", "金杨", "南码头", "潍坊", "花木", "源深", "杨东", "碧云", "森兰", "外高桥", "临港主城区"),
    "奉贤区": ("西渡", "南桥", "奉贤金汇", "海湾", "柘林", "奉城", "四团", "青村", "庄行"),
    "青浦区": ("华新", "重固", "白鹤", "赵巷", "香花桥", "夏阳", "盈浦", "朱家角", "金泽", "练塘"),
    "松江区": ("泗泾", "洞泾", "新桥", "佘山", "小昆山", "车墩", "新浜", "石湖荡", "泖港", "叶榭", "九亭", "莘闵别墅", "松江大学城", "松江老城"),
    "崇明区": ("崇明新城", "陈家镇", "长兴岛", "堡镇", "横沙岛"),
