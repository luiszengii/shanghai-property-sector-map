...
const seeds = [
  ...
  { id: "sector_shanghainan_zhan", name: "上海南站", center: [121.4266, 31.1553], radii: [0.018, 0.014], rotationDegrees: 10 },
  ...
  { id: "sector_suhewan", name: "苏河湾", center: [121.476, 31.246], radii: [0.018, 0.012], rotationDegrees: -4 },
  ...
  { id: "sector_lianyang", name: "联洋", center: [121.573, 31.232], radii: [0.019, 0.017], rotationDegrees: 5 },
  { id: "sector_yangdong", name: "杨东", center: [121.5283, 31.2009], radii: [0.015, 0.013], rotationDegrees: -5 },
  { id: "sector_senlan", name: "森兰", center: [121.607, 31.292], radii: [0.027, 0.021], rotationDegrees: 10 },
  { id: "sector_waigaoqiao", name: "外高桥", center: [121.616, 31.343], radii: [0.04, 0.028], rotationDegrees: -6 },
  ...
  { id: "sector_nanda", name: "南大", center: [121.385, 31.3], radii: [0.032, 0.023], rotationDegrees: -5 },
